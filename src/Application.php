...
class Application extends \Symfony\Component\Console\Application
{
    ...
    protected function configureIO(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->filesystem = new Filesystem($changelogPath, $entriesPath);
        $this->repository = $git;

        $this->handler = new YamlHandler();
        $this->factory = new EntryFileFactory(new YamlHandler(), $git);
    }
    ...
    protected function getDefaultCommands()
    {
        ...
        $own = [
            new CreateCommand($this->factory, $this->filesystem, $this->repository),
            new Parse(
                $this->filesystem,
